...
st.sidebar.subheader("Global Sourcing Insights")
st.sidebar.write("A Proof of Concept for crawling Trending News and analyzing them with Natural Language Processing")
...
filter = st.sidebar.radio("Filter by Sentiment-Category", ('All', 'Positive', 'Neutral', 'Negative')) # Filter nach Sentiment-Score
...
commodity_price = st.sidebar.selectbox("Select a Commodity to see current Prices and Trending News:", ['Coal', 'Nickel', 'Zinc']) # Dropdown zur Auswahl eines Rohstoffs
